...
import { ArrowLeft, Save, Wand2, Workflow } from 'lucide-react'
...
import { CreateAgentRequest, AgentConfiguration } from '@/services/api'
    ...
    <AppLayout>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-foreground">{t('createNewAgent', 'agents')}</h1>
            <p className="text-muted-foreground mt-1">
              {t('configureYourAgent', 'agents')}
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-between">
          ...
          <div className="flex gap-3">
            <Button type="button" variant="outline" disabled>
              ...
              {t('useTemplate', 'agents')}
            </Button>
            <Button type="submit" disabled={isLoading}>
              <Save className="w-4 h-4 mr-2" />
              {isLoading ? t('creating', 'agents') : t('createAgent', 'agents')}
            </Button>
          </div>
        </div>
      </form>
